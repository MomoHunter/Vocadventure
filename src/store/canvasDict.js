...
export default {
  ...
  state: {
    ...
    spriteDict: {
      ...
      'story_f0_chromander': [false, 101, 0, 108, 108],
      'story_f0_chromander_eye': [false, 101, 109, 305, 116],
      'story_f0_construction_site': [false, 101, 226, 600, 300],
      'story_f0_construction_site_crane': [false, 101, 527, 199, 121],
      'story_f0_construction_site_roller': [false, 101, 649, 140, 122],
      'story_f0_construction_site_tree': [false, 101, 772, 46, 34],
      'story_f0_hand': [false, 101, 807, 250, 167],
      'story_f0_parents': [false, 101, 975, 680, 340],
      'story_f0_park': [false, 101, 1316, 300, 300],
      'story_f0_park_chrome': [false, 101, 1617, 300, 300],
      'story_f0_red_arrow': [false, 101, 1918, 25, 30],
      'story_f0_smartphone': [false, 101, 1949, 620, 720],
      'story_f0_star_map': [false, 101, 2670, 600, 300],
      'story_f0_video_background': [false, 101, 2971, 600, 300],
      'story_f0_video_clock_base': [false, 101, 3272, 600, 300],
      'story_f0_video_clock_center': [false, 101, 3573, 10, 10],
      'story_f0_video_clock_hour': [false, 101, 3584, 10, 36],
      'story_f0_video_clock_minute': [false, 101, 3621, 8, 63],
      'story_f0_video_clock_second': [false, 101, 3685, 2, 75],
      'story_f0_video_foreground': [false, 101, 3761, 600, 300],
      'story_f0_video_moderator_eyes': [true, 101, [4062, 4078, 4094, 4110], 43, 15],
      'story_f0_video_moderator_eyes_open': [false, 101, 4126, 43, 15],
      'story_f0_video_moderator_mouth': [true, 101, [4142, 4151], 23, 8],
      'story_f0_video_moderator_mouth_closed': [false, 101, 4160, 23, 8],
      'story_f0_video_start_background': [false, 101, 4169, 600, 300],
      'story_f0_video_start_button': [false, 101, 4470, 100, 100],
      'story_f0_woogle': [false, 101, 4571, 600, 300],
      'story_f0_woogle_car': [false, 101, 4872, 74, 47],
      'story_f0_woogle_truck': [false, 101, 4920, 143, 71],

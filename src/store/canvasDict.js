...
export default {
  ...
  state: {
    ...
    spriteDict: {
      ...
      'story_f0_video_clock_base': [false, 101, 3965, 600, 300],
      'story_f0_video_clock_center': [false, 101, 4266, 10, 10],
      'story_f0_video_clock_hour': [false, 101, 4277, 10, 36],
      'story_f0_video_clock_minute': [false, 101, 4314, 8, 63],
      'story_f0_video_clock_second': [false, 101, 4378, 2, 75],
      'story_f0_video_foreground': [false, 101, 4454, 600, 300],
      'story_f0_video_moderator_eyes': [true, 101, [4755, 4771, 4787, 4803], 43, 15],
      'story_f0_video_moderator_eyes_open': [false, 101, 4819, 43, 15],
      'story_f0_video_moderator_mouth': [true, 101, [4835, 4844], 23, 8],
      'story_f0_video_moderator_mouth_closed': [false, 101, 4853, 23, 8],
      'story_f0_video_start_background': [false, 101, 4862, 600, 300],
      'story_f0_video_start_button': [false, 101, 5163, 100, 100],
      'story_f0_woogle': [false, 101, 5264, 600, 300],
      'story_f0_woogle_car': [false, 101, 5565, 74, 47],
      'story_f0_woogle_truck': [false, 101, 5613, 143, 71],

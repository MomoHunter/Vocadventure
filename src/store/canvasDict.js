...
export default {
  ...
  state: {
    ...
    spriteDict: {
      ...
      'story_f0_hand': [false, 101, 799, 250, 167],
      'story_f0_inside_explorer': [false, 101, 967, 100, 98],
      'story_f0_parents': [false, 101, 1066, 680, 340],
      'story_f0_park': [false, 101, 1407, 300, 300],
      'story_f0_park_chrome': [false, 101, 1708, 300, 300],
      'story_f0_red_arrow': [false, 101, 2009, 25, 30],
      'story_f0_smartphone': [false, 101, 2040, 620, 720],
      'story_f0_star_map': [false, 101, 2761, 600, 300],
      'story_f0_video_background': [false, 101, 3062, 600, 300],
      'story_f0_video_clock_base': [false, 101, 3363, 600, 300],
      'story_f0_video_clock_center': [false, 101, 3664, 10, 10],
      'story_f0_video_clock_hour': [false, 101, 3675, 10, 36],
      'story_f0_video_clock_minute': [false, 101, 3712, 8, 63],
      'story_f0_video_clock_second': [false, 101, 3776, 2, 75],
      'story_f0_video_foreground': [false, 101, 3852, 600, 300],
      'story_f0_video_moderator_eyes': [true, 101, [4153, 4169, 4185, 4201], 43, 15],
      'story_f0_video_moderator_eyes_open': [false, 101, 4217, 43, 15],
      'story_f0_video_moderator_mouth': [true, 101, [4233, 4242], 23, 8],
      'story_f0_video_moderator_mouth_closed': [false, 101, 4251, 23, 8],
      'story_f0_video_start_background': [false, 101, 4260, 600, 300],
      'story_f0_video_start_button': [false, 101, 4561, 100, 100],
      'story_f0_woogle': [false, 101, 4662, 600, 300],
      'story_f0_woogle_car': [false, 101, 4963, 74, 47],
      'story_f0_woogle_truck': [false, 101, 5011, 143, 71],

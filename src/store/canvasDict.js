...
export default {
  ...
  state: {
    ...
    spriteDict: {
      ...
      'story_f0_video_clock_base': [false, 101, 1863, 600, 300],
      'story_f0_video_clock_center': [false, 101, 2164, 10, 10],
      'story_f0_video_clock_hour': [false, 101, 2175, 10, 36],
      'story_f0_video_clock_minute': [false, 101, 2212, 8, 63],
      'story_f0_video_clock_second': [false, 101, 2276, 2, 75],
      'story_f0_video_foreground': [false, 101, 2352, 600, 300],
      'story_f0_video_moderator_eyes': [true, 101, [2653, 2669, 2685, 2701], 43, 15],
      'story_f0_video_moderator_eyes_open': [false, 101, 2717, 43, 15],
      'story_f0_video_moderator_mouth': [true, 101, [2733, 2742], 23, 8],
      'story_f0_video_moderator_mouth_closed': [false, 101, 2751, 23, 8],
      'story_f0_video_start_background': [false, 101, 2760, 600, 300],
      'story_f0_video_start_button': [false, 101, 3061, 100, 100],
      'story_f0_woogle': [false, 101, 3162, 600, 300],
      'story_f0_woogle_car': [false, 101, 3463, 74, 47],
      'story_f0_woogle_truck': [false, 101, 3511, 143, 71],

...
export default {
  ...
  state: {
    ...
    spriteDict: {
      ...
      'story_f0_video_clock_base': [false, 101, 5191, 600, 300],
      'story_f0_video_clock_center': [false, 101, 5492, 10, 10],
      'story_f0_video_clock_hour': [false, 101, 5503, 10, 36],
      'story_f0_video_clock_minute': [false, 101, 5540, 8, 63],
      'story_f0_video_clock_second': [false, 101, 5604, 2, 75],
      'story_f0_video_foreground': [false, 101, 5680, 600, 300],
      'story_f0_video_moderator_eyes': [true, 101, [5981, 5997, 6013, 6029], 43, 15],
      'story_f0_video_moderator_eyes_open': [false, 101, 6045, 43, 15],
      'story_f0_video_moderator_mouth': [true, 101, [6061, 6070], 23, 8],
      'story_f0_video_moderator_mouth_closed': [false, 101, 6079, 23, 8],
      'story_f0_video_start_background': [false, 101, 6088, 600, 300],
      'story_f0_video_start_button': [false, 101, 6389, 100, 100],
      'story_f0_weird_pic_man': [false, 101, 6490, 93, 127],
      'story_f0_woogle': [false, 101, 6618, 600, 300],
      'story_f0_woogle_car': [false, 101, 6919, 74, 47],
      'story_f0_woogle_truck': [false, 101, 6967, 143, 71],

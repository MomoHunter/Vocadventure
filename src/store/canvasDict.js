...
export default {
  ...
  state: {
    ...
    spriteDict: {
      ...
      'story_f0_red_arrow': [false, 101, 2310, 25, 30],
      'story_f0_smartphone': [false, 101, 2341, 620, 720],
      'story_f0_star_map': [false, 101, 3062, 600, 300],
      'story_f0_video_background': [false, 101, 3363, 600, 300],
      'story_f0_video_clock_base': [false, 101, 3664, 600, 300],
      'story_f0_video_clock_center': [false, 101, 3965, 10, 10],
      'story_f0_video_clock_hour': [false, 101, 3976, 10, 36],
      'story_f0_video_clock_minute': [false, 101, 4013, 8, 63],
      'story_f0_video_clock_second': [false, 101, 4077, 2, 75],
      'story_f0_video_foreground': [false, 101, 4153, 600, 300],
      'story_f0_video_moderator_eyes': [true, 101, [4454, 4470, 4486, 4502], 43, 15],
      'story_f0_video_moderator_eyes_open': [false, 101, 4518, 43, 15],
      'story_f0_video_moderator_mouth': [true, 101, [4534, 4543], 23, 8],
      'story_f0_video_moderator_mouth_closed': [false, 101, 4552, 23, 8],
      'story_f0_video_start_background': [false, 101, 4561, 600, 300],
      'story_f0_video_start_button': [false, 101, 4862, 100, 100],
      'story_f0_woogle': [false, 101, 4963, 600, 300],
      'story_f0_woogle_car': [false, 101, 5264, 74, 47],
      'story_f0_woogle_truck': [false, 101, 5312, 143, 71],

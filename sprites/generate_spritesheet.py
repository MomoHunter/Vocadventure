...
with open('../src/store/canvasDict.js') as f:  # read surrounding text
    file_text = f.read()
    file_text_pre, file_text = file_text.split(text_indent_2 + start_marker_text)
    _, file_text_post = file_text.split(end_marker_text)

with open('../src/store/canvasDict.js', 'w') as f:  # clear file and write new text
